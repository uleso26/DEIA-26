...
# Test: orchestrator pathway response contains disclaimer.
...
# Test: trial name query resolves correct trial.
...
# Test: target only query lists linked drugs.
...
# Test: guideline selection respects ada obesity intent.
...
# Test: initial treatment query returns direct metformin answer with guideline citations.
...
# Test: literature update excludes irrelevant glp1 review.
...
# Test: expanded catalog supports cost sensitive pathway query.
...
# Test: guideline difference query stays in pathway scope.
...
# Test: trial query exposes execution plan metadata.
...
# Test: trial publication query prefers trial publication over generic recent literature.
