...
# Verify population context tool returns WHO record
...
# Verify LangChain native tool returns structured payload
...
# Verify clinical context tool returns drugbank and synthetic matches
