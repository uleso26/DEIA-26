...
# Verify LangGraph workflow exposes expected nodes
...
# Verify evidence planner returns bounded trial plan
...
# Verify evidence planner refines with fallback node when evidence is limited
...
# Verify governance checker does not mutate caveats
...
# Verify scope routes skip Ollama synthesis
